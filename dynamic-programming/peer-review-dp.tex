...
\begin{document}
	...
	\]
	The goal is to maximize net value: total value minus $\mathrm{cost}(\text{total liquid})$.
	...
	maximize $\sum v_i$ subject to $\sum l_i \le L$.
	...
	\end{itemize}
	So it is not optimal to buy extra liquid.
	...
	We call $\mathrm{OPT}(n,L)$ to obtain the optimal net value for the full instance.
	...
	Using $Q \le nK$, a valid upper bound is $O(n^2 L K)$.
